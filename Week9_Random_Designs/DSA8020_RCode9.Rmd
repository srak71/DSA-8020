---
title: "DSA 8020 R Session 9: Completely Randomized Designs"
author: "Whitney"
output:
  pdf_document:
    toc: true
...
The experimenter (Meily Lin) had observed that some colors of birthday balloons
...
experimenter recorded the times with a stop watch. The data, in the
...
```{r}
plot(mod1$fitted, mod1$resid, las = 1, xlab = "Fitted value", ylab = "Residual",
     cex = 0.75, col = "blue")
abline(h = 0)
...
```{r,echo=FALSE}
par(mfrow = c(2, 1), las = 1, mar = c(3.5, 3.5, 1, 0.5), mgp = c(2, 1, 0))
